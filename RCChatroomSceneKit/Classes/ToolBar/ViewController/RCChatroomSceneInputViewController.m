...
- (HPGrowingTextView *)textView {
    if (_textView == nil) {
        ...
        _textView.placeholder = @"聊聊吧...";
        _textView.placeholderColor = [UIColor colorWithWhite:0.8 alpha:1];
        _textView.backgroundColor = UIColor.whiteColor;
        _textView.layer.cornerRadius = 6;
        _textView.layer.masksToBounds = YES;
        _textView.contentInset = UIEdgeInsetsMake(0, 6, 0, 6);
    }
    return _textView;
}
...
- (void)viewDidLoad {
    ...
    if (self.config.inputViewEmojiEnable) {
